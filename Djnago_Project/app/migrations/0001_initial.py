    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_query_name='author', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_query_name='author', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
